            ...
            @foreach ($units as $key=> $item)
                <tr>
                    ...
                    <td><label class="custom-switch mt-2">
                            <input type="checkbox" name="custom-switch-checkbox" data-table="units"
                                   data-id="{{ $item->id }}"
                    ...
                    <td><div class="dropdown d-inline">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-start">
                                <a class="dropdown-item has-icon"
                                   href="{{ route('units.edit',$item->id) }}"><i
                        ...
                        <form class="trash_form" action="{{ route('units.destroy',$item->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                        </form>
                    </td>
