...
class Purchase extends Model
{
    ...
    protected $fillable = ['date','contact_id','purchase_no','discount','discount_type','discount_amount','vat','vat_type','vat_amount','total_quantity','total_amount','status','is_paid','notes'];
